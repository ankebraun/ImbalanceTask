...
if tone == 2 % flat tone
    if response == 2
        correct = 1; %hit
        if setup.Eye
            Eyelink('message', sprintf('decision %i', trigger_enc.hit))
        end
    ...
    elseif response == 1
        correct = 2; %miss
        if setup.Eye
            Eyelink('message', sprintf('decision %i', trigger_enc.miss))
        end
...
elseif tone == 1 % ripple tone
    if response == 1
        ...
        if setup.Eye
            Eyelink('message', sprintf('decision %i', trigger_enc.correct_reject))
        end
    ...
    elseif response == 2;
        ...
        if setup.Eye
            Eyelink('message', sprintf('decision %i', trigger_enc.false_alarm))
        end
