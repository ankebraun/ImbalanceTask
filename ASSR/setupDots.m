...
dots.radius            = deg2pix(12); %keep constant
dots.innerspace        = deg2pix(2);
% dots.lifetime          = 6; % in frames
% dots.nvar              = 3; %interleave three variants of the stimulus
...
% dots.speed             = deg2pix(11.5); % speed of the dots in degrees/second
% dots.size              = deg2pix(0.2); %size of each dot in degrees
...
fix.dotsize         = deg2pix(0.19);%0.2); % fixation dot
fix.circlesize      = deg2pix(0.6); % circle around fixation dot
fix.color           = [255 0 0];
